...
Pipeline order (set in settings.py):
  ...
  300 EnrichmentPipeline       — AI title/summary/link_text via LLM
...
class ScoreFilterPipeline:
    """Score each article via LLM and drop those below RELEVANCE_THRESHOLD."""
...
class EnrichmentPipeline:
    """Batch-enrich articles with LLM: score → filter → title/summary/link_text."""
